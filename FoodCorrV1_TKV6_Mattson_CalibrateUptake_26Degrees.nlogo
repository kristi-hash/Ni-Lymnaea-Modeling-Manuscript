...
to init_globals
  ...
  ; Toxicokinetics (elimination rate) - V3 Kristi
   ...
   ;set k_e 0.0429 ;calibrated k_e 18 degrees
   set k_e 0.02361836 ;calibrated k_e 26 degrees
   ;set k_u k_u_min + random-float (k_u_max - k_u_min) ;calibrating k_e
   ;set k_u  0.00012 ;calibrated k_u 18 degrees
   set k_u 0.000198911 ;calibrated k_u 26 degrees
   set k_u 0.000409055 ;calibrated k_u 26 degrees
...
103
OutputFileName
FoodCorrV2_TKV6_Mattson_PredictInternalConcentration_26Degrees
1
0
String
